                ...
                <section id="contact">
                    <div class="contact-box">
                        ...
                        <div class="contact-form-wrapper">
                            <form id="suggestion_box">
                                <div class="form-item">
                                    <input type="text" name="sender" id="user_name" style="font-size: 40px;" required>
                                    <label>Name:</label>
                                </div>
                                <div class="form-item">
                                    <textarea class="message_box" name="message" style="font-size: 20px;" id="user_message" required></textarea>
                                    <label>Message:</label>
                                </div>
                                <button type="submit" class="submit-btn" onclick="sendReview()">Send</button>
                            </form>
                        </div>
                    </div>
                </section>
