...
pageEncoding="ISO-8859-1"%>
    ...
    <head>
        <meta charset="utf-8" name="viewport" content="maximum-scale=0.5">
    ...
    <body>
        ...
        <div id="mainbody">
            ...
            <!-- Contact me section... -->
            <div class="generic_div contact_box_contents">
                <div class="header-common-left" id="contact_heading">
                    Contact me
                </div>
                <div class="contact_box_contents">
                    <section id="contact">
                        <div class="contact-box">
                            <div class="contact-links">
                                <h2>Thank you for choosing to share your opinions</h2>
                                <div style="text-align: justify;color:white">
                                    <br> The project is an honest attempt to reach as close to professionalism as possible. Every suggestion provided, every opinion shared, and every bug reported will help me take a step closer to that level. I thank
                                    you profusely for choosing to connect with me.</br>
                                </div>
                                <div class="links">
                                    <div class="link">
                        ...
                        <div class="contact-form-wrapper">
                            <form>
                                <div class="form-item">
                                    <input class="input_fields" type="text" name="sender" id="user_name" required>
                                    <label>Name:</label>
                                </div>
                                <div class="form-item">
                                    <input class="input_fields" type="email" name="email" id="email_id" required>
                                    <label>Email:</label>
                                </div>
                                <div class="form-item">
                                    <textarea class="input_fields" name="message" id="user_message" required style="resize: none;height:200px;"></textarea>
                                    <label>Message:</label>
                                </div>
                                <button class="submit-btn input_fields" onclick="sendReview();return false">Send</button>
                            </form>
                        </div>
                    </section>
